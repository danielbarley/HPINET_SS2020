//
// Generated file, do not edit! Created by nedtool 5.6 from src/packet.msg.
//
...
::omnetpp::simtime_t Packet::getEnqueued() const
{
    return this->enqueued;
}

void Packet::setEnqueued(::omnetpp::simtime_t enqueued)
{
...
int PacketDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='e' && strcmp(fieldName, "enqueued")==0) return base+2;
...
std::string PacketDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 2: return simtime2string(pp->getEnqueued());
        default: return "";
    }
}
...
bool PacketDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 2: pp->setEnqueued(string2simtime(value)); return true;
