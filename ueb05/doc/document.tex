    ...
    \begin{itemize}
        ...
        \item \verb|avg End-to-End Latency|
            \begin{itemize}
                ...
                \item maximum
                    \begin{itemize}
                        \item all apps send to same destinatino and arbiter has to do round robin for all packets \textrightarrow 4 times the dely for the Datarate Cahnnel inside XBar
