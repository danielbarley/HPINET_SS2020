...
/**
 * Class generated from <tt>src/MyPacket.msg:19</tt> by nedtool.
 * <pre>
 * //
 ...
 * packet MyPacket
 * {
 *     int seen; // revord number of times this package was received by tic
 * }
 * </pre>
 */
class MyPacket : public ::omnetpp::cPacket
{
  ...
  public:
    ...
    virtual int getSeen() const;
    virtual void setSeen(int seen);
};
